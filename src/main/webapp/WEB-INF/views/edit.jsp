              ...
              <div class="col-md-6 col-sm-xs-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form:form action="${pageContext.request.contextPath}/editar" method="post" id="demo-form">
						...
						<input type="text" id="nombres" class="form-control" name="nombres" placeholder="Nombre" value="${model.nombres }" required />
						
						<label for="apellidos">Last Name * :</label>
						<input type="text" id="apellidos" class="form-control" name="apellidos" placeholder="Apellidos" value="${model.apellidos }" required />

						<label for="edad">Age * :</label>
						<input type="text" id="edad" class="form-control" name="edad" placeholder="Edad" value="${model.edad }" required />
